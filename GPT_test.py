...
def main_dashboard():
  ...
  if uploaded_file_keywords is not None and uploaded_file_search_terms is not None and campaign != "" and ad_group != "":
        ...
        messages = [
            {"role": "system", "content": "You are a digital marketer analyzing a search terms report from Google Ads for a solar company called Axia. You need to identify terms that could be possible additions to a given campiagn and ad group combination. You should disregard any mentions of competitors (i.e. Tesla and other companies) as well as terms that would be bad for business like 'free' or questions. Use your previous knowledge of Search Query reporting in this task."},
